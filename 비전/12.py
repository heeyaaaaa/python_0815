...
def morph():
    img = cv2.imread('erosion.png', cv2.IMREAD_GRAYSCALE)
...
def morph2():
    img1 = cv2.imread('opening.png', cv2.IMREAD_GRAYSCALE)
    img2 = cv2.imread('closing.png', cv2.IMREAD_GRAYSCALE)
...
def morph3():
    img1 = cv2.imread('erosion.png', cv2.IMREAD_GRAYSCALE)
    img2 = cv2.imread('opening.png', cv2.IMREAD_GRAYSCALE)
    img3 = cv2.imread('closing.png', cv2.IMREAD_GRAYSCALE)
